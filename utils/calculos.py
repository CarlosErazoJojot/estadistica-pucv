...
PUCV_GOLD  = "#7D6220"   # dorado oscurecido para contraste sobre blanco
...
.page-header .formula { color: #E8D9A8; font-size: 0.88rem; }

.seccion-label {
    color: #003087; font-size: 0.74rem; letter-spacing: 0.15em; font-weight: 700;
    border-bottom: 2px solid #7D6220; padding-bottom: 8px; margin-bottom: 16px;
}

.stat-box {
    background: #F4F7FB; border: 1px solid #D4DEEC;
    border-top: 3px solid #7D6220; border-radius: 8px;
