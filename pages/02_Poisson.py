...
with st.sidebar:
    ...
    st.page_link("pages/01_Binomial.py", label="Binomial", icon=":material/arrow_back:")
    st.page_link("pages/03_Geometrica.py", label="Geométrica", icon=":material/arrow_forward:")
